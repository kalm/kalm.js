(function (global, factory) {
    ...
    (global = global || self, global.kalm = factory(global.events));
    ...
    function listen(options) {
        ...
        return Provider({ ...defaults, ...options }, new events.EventEmitter());
    }
    function connect(options) {
        options.label = options.label || Math.random().toString(36).substring(7);
        return Client({ ...defaults, ...options }, new events.EventEmitter());
    }
    var kalm = {
        connect,
        listen,
